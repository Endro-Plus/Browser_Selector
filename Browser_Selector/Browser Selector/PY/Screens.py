    ...
    for x in range(0, 3):
        for y in range(0, 3):
            ...
            if([x, y] in shortcut):
                ...
                #create the button
                btn.append(tk.Button(frame, fg="grey", padx=20, pady=20, width=80, height=75, borderwidth=0, font="12px", image=img, command = lambda imgpath=imgpath : open_browser(imgpath, mainscreen, frame)))
